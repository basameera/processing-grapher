...
class Plot 
{
  ...
  Plot(int x, int y, int w, int h, color k) {  // The main declaration function
    xPos = x;
    yPos = y;
    Width = w;
    Height = h;
  ...
  void smoothLine(float[] x, float[] y) {
    ...
    for (int i=0; i<x.length; i++) {
      ...
      /* =================================================================================       
       For the rest of the array a curve (spline curve) can be created making the Plot 
       smooth.     
       ================================================================================= */
  ...
  void smoothLine(float[] x, float[] y, float[] z, float[] a ) {
    PlotColor=color(188, 53, 53);
    smoothLine(x, y);
    PlotColor=color(193-100, 216-100, 16);
    smoothLine(z, a);
  }
}
